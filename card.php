<!-- just in case for change my mind -->
...
<body>
    ...
    <div class="container">
        <h1 class="text-center" style="margin-top: 5px; margin-bottom: 50px;">ข้อมูลสถานะ การติดตาม</h1>
        <div class="row">
            <?php
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <p class="card-text"><strong>File PDF:</strong><b> <?php echo htmlspecialchars($row["V_File"]); ?></b></p>
                            </div>
                        </div>
                    </div>
                    <?php
